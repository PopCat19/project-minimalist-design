...
export function renderComponentReference(pmd: PMDVariables, hue: number): void {
	...
	if (!container.dataset.ready) {
		container.innerHTML = [
			...
			// Toggle pill
			`<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.375rem;display:flex"><div class="cref-tgl" style="background:var(--cref-tgl-on-bg);border:2px solid var(--cref-tgl-on-bor)"></div><div class="cref-tgl" style="background:var(--cref-panel);border:2px solid var(--cref-tgl-off-bor)"></div><div class="cref-tgl" style="background:transparent;border:2px solid var(--cref-dis-ol);display:flex;align-items:center;justify-content:center"><span class="material-symbols-rounded" style="color:var(--cref-dis-fg);font-size:0.625rem;font-variation-settings:'wght' 700,'FILL' 1">close</span></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">On</span><span class="cref-tok-stack">88x · 88x b</span><span class="cref-tok-hex" data-cref="tgl-on-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Off</span><span class="cref-tok-stack">4x · 80×48% b</span><span class="cref-tok-hex" data-cref="tgl-off-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Disabled</span><span class="cref-tok-stack">80×8% OL</span><span class="cref-tok-hex" data-cref="dis-ol"></span></div></div><div class="cref-label">Pill Toggle</div></div>`,
			// Radio
			...
			// ── Pagination ──
			`<div class="cref-group"><h3 class="cref-group-title">Pagination</h3><div class="cref-grid"><div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel)"><div class="cref-pagination"><div class="cref-dot-pill" style="background:var(--cref-pg-active)"></div><div class="cref-dot-circle" style="background:var(--cref-pg-inactive)"></div><div class="cref-dot-circle" style="background:var(--cref-pg-inactive)"></div><div class="cref-dot-circle" style="background:var(--cref-pg-inactive)"></div></div><div style="display:flex;gap:0.25rem"><span class="material-symbols-rounded" style="font-size:0.75rem;color:var(--cref-pg-inactive)">chevron_left</span><span class="material-symbols-rounded" style="font-size:0.75rem;color:var(--cref-pg-active)">chevron_right</span></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Active</span><span class="cref-tok-stack">88x</span><span class="cref-tok-hex" data-cref="pg-active"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Inactive</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-hex" data-cref="pg-inactive"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Disabled</span><span class="cref-tok-stack">88×24% icon</span><span class="cref-tok-hex" data-cref="dis-fg"></span></div></div><div class="cref-label">Pill + Circles + Chevrons</div></div></div></div>`,
