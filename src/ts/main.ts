// main.ts
//
// Purpose: Entry point for PMD Base16 theme generator
//
// This module:
// - Initializes event listeners and UI state
// - Coordinates hue selection, scheme toggling, and rendering
// - Exports global functions for inline HTML handlers
import {
	type Base16Palette,
	generatePalette,
	getAuxHue,
...
function initEventListeners(): void {
	...
	if (hueInput) {
		hueInput.addEventListener("change", (e) => {
			let val = parseInt((e.target as HTMLInputElement).value, 10) || 0;
