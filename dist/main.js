...
function renderComponentReference(pmd, hue) {
  ...
  if (!container.dataset.ready) {
    container.innerHTML = [
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.375rem;display:flex"><div class="cref-btn" style="background:var(--cref-dis-bg);color:var(--cref-dis-fg);outline-color:var(--cref-dis-ol)">Disabled</div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Surface</span><span class="cref-tok-stack">80×8%</span><span class="cref-tok-var">--base02</span><span class="cref-tok-hex" data-cref="dis-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Text</span><span class="cref-tok-stack">88×24%</span><span class="cref-tok-hex" data-cref="dis-fg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Outline</span><span class="cref-tok-stack">80×8%</span><span class="cref-tok-hex" data-cref="dis-ol"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Weight</span><span class="cref-tok-stack">—</span><span class="cref-tok-var">500</span></div></div><div class="cref-label">Disabled</div></div>`,
      `</div></div>`,
      `<div class="cref-group"><h3 class="cref-group-title">Tabs</h3><div class="cref-grid"><div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel)"><div class="cref-tab"><div class="cref-tab-sel" style="background:var(--cref-tab-sel-bg);color:var(--cref-tab-sel-fg);border-radius:var(--r);padding:0.25rem 0.625rem;font-size:var(--fs);font-weight:600">Music</div><div class="cref-tab-unsel" style="background:var(--cref-tab-unsel-bg);color:var(--cref-tab-unsel-fg);border-radius:var(--r);padding:0.25rem 0.625rem;font-size:var(--fs);font-weight:500">Output</div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Fill</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="tab-sel-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Text on</span><span class="cref-tok-stack">4x</span><span class="cref-tok-var">--base01</span><span class="cref-tok-hex" data-cref="tab-sel-fg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Muted</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="tab-unsel-fg"></span></div></div><div class="cref-label">Selected · Unselected</div></div></div></div>`,
      `<div class="cref-group"><h3 class="cref-group-title">Togglables</h3><div class="cref-grid">`,
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.375rem;display:flex"><div class="cref-tgl" style="background:var(--cref-tgl-on-bg);border:2px solid var(--cref-tgl-on-bor)"></div><div class="cref-tgl" style="background:var(--cref-tgl-off-bg);border:2px solid var(--cref-tgl-off-bor)"></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Fill(on)</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="tgl-on-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Border(on)</span><span class="cref-tok-stack">88x</span><span class="cref-tok-hex" data-cref="tgl-on-bor"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Track(off)</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="tgl-off-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Border(off)</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-hex" data-cref="tgl-off-bor"></span></div></div><div class="cref-label">Pill Toggle</div></div>`,
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.5rem;display:flex"><div class="cref-radio" style="background:var(--cref-radio-on)"></div><div class="cref-radio" style="background:var(--cref-radio-off)"></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Active</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="radio-on"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Inactive</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="radio-off"></span></div></div><div class="cref-label">Radio</div></div>`,
      `</div></div>`,
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);padding:0.5rem"><div class="cref-notif" style="background:var(--cref-notif-bg);border:2px solid var(--cref-alert-border);border-radius:var(--r);padding:0.5rem 0.75rem"><div style="font-weight:600;font-size:var(--fs);color:var(--cref-alert-fg);margin-bottom:0.125rem">Abyssal Mage</div><div style="font-size:0.625rem;color:var(--cref-notif-bd);line-height:1.25">You have reached the maximum quota. Please, do touch some grass.</div><div style="display:flex;gap:0.25rem;margin-top:0.375rem"><div class="cref-btn" style="background:var(--cref-alert-fg);color:var(--cref-panel);font-size:0.625rem;padding:0.25rem 0.5rem;border-radius:var(--r);font-weight:500">Go bask in ze breeze</div><div class="cref-btn" style="background:var(--cref-notif-bg);color:var(--cref-alert-fg);font-size:0.625rem;padding:0.25rem 0.5rem;border-radius:var(--r);font-weight:500">Copy</div></div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Surface</span><span class="cref-tok-stack">8x</span><span class="cref-tok-var">--base01</span><span class="cref-tok-hex" data-cref="notif-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Border</span><span class="cref-tok-stack">88×12</span><span class="cref-tok-hex" data-cref="alert-border"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Title</span><span class="cref-tok-stack">88×12 · 600</span><span class="cref-tok-hex" data-cref="alert-fg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Body</span><span class="cref-tok-stack">80x · 500</span><span class="cref-tok-hex" data-cref="notif-bd"></span></div></div><div class="cref-label">Priority</div></div>`,
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);padding:0.5rem"><div class="cref-notif" style="background:var(--cref-notif-bg);border-radius:var(--r);padding:0.5rem 0.75rem"><div style="font-weight:600;font-size:var(--fs);color:var(--cref-notif-h);margin-bottom:0.125rem">popcan19</div><div style="font-size:0.625rem;color:var(--cref-notif-bd);line-height:1.25">lost my 50/50 again :feelsbadman:</div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Surface</span><span class="cref-tok-stack">8x</span><span class="cref-tok-var">--base01</span><span class="cref-tok-hex" data-cref="notif-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Title</span><span class="cref-tok-stack">88x · 600</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="notif-h"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Body</span><span class="cref-tok-stack">80x · 500</span><span class="cref-tok-var">--base05</span><span class="cref-tok-hex" data-cref="notif-bd"></span></div></div><div class="cref-label">Standard</div></div>`,
      `</div></div>`,
      `<div class="cref-group"><h3 class="cref-group-title">Slider</h3><div class="cref-grid"><div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);flex-direction:column;align-items:stretch;gap:0.25rem;padding:0.625rem 0.5rem"><div style="font-size:var(--fs);font-weight:500;color:var(--cref-sl-dot);margin-bottom:0.125rem">Navi 32 HDMI/DP Audio Digital Stereo</div><div style="display:flex;justify-content:space-between"><span style="font-size:var(--fs);font-weight:600;color:var(--cref-sl-fill)">64%</span><span style="font-size:var(--fs);font-weight:500;color:var(--cref-sl-track)">150%</span></div><div class="cref-slider-std"><div class="cref-sl-std-fill" style="background:var(--cref-sl-fill);width:2.5rem"></div><div class="cref-sl-std-knob" style="background:var(--cref-sl-fill)"></div><div class="cref-sl-std-track" style="background:var(--cref-sl-track)"><div style="margin-left:auto;margin-right:0.25rem"><div class="cref-sl-std-dot" style="background:var(--cref-sl-dot)"></div></div></div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Active</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="sl-fill"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Track</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="sl-track"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Handle</span><span class="cref-tok-stack">4×32px · 88x</span><span class="cref-tok-hex" data-cref="sl-fill"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Stop</span><span class="cref-tok-stack">4×4px · 80x</span><span class="cref-tok-hex" data-cref="sl-dot"></span></div></div><div class="cref-label">Standard</div></div></div></div>`,
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);flex-direction:column;align-items:stretch;gap:0.25rem"><div style="display:flex;justify-content:space-between"><span style="font-size:var(--fs);font-weight:600;color:var(--cref-sl-fill)">72%</span><span style="font-size:var(--fs);font-weight:500;color:var(--cref-sl-track)">100%</span></div><div class="cref-slider-std" style="overflow:hidden"><div class="cref-sl-std-fill" style="background:var(--cref-sl-fill);width:2.5rem"></div><div class="cref-sl-std-track" style="background:var(--cref-sl-track);border-radius:4px var(--r) var(--r) 4px"></div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Fill</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="sl-fill"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Track</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="sl-track"></span></div></div><div class="cref-label">Progress Bar</div></div>`,
      `</div></div>`
    ].join("");
    container.dataset.ready = "1";
  }
  ...
  root.style.setProperty("--cref-dis-bg", h80x8);
