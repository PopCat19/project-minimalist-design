...
function renderComponentReference(pmd, hue) {
  ...
  if (!container.dataset.ready) {
    container.innerHTML = [
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.375rem;display:flex"><div class="cref-tgl" style="background:var(--cref-tgl-on-bg);border:2px solid var(--cref-tgl-on-bor)"></div><div class="cref-tgl" style="background:var(--cref-panel);border:2px solid var(--cref-tgl-off-bor)"></div><div class="cref-tgl" style="background:transparent;border:2px solid var(--cref-dis-ol);display:flex;align-items:center;justify-content:center"><span style="color:var(--cref-dis-fg);font-size:0.625rem;font-weight:700;font-family:Fredoka;line-height:0">×</span></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">On</span><span class="cref-tok-stack">88x · 88x b</span><span class="cref-tok-hex" data-cref="tgl-on-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Off</span><span class="cref-tok-stack">4x · 80×48% b</span><span class="cref-tok-hex" data-cref="tgl-off-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Disabled</span><span class="cref-tok-stack">80×8% OL</span><span class="cref-tok-hex" data-cref="dis-ol"></span></div></div><div class="cref-label">Pill Toggle</div></div>`,
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.5rem;display:flex"><div class="cref-radio" style="border-color:var(--cref-radio-on)"></div><div class="cref-radio" style="border-color:var(--cref-radio-off)"></div><div class="cref-radio" style="border-color:var(--cref-dis-ol);background:transparent"><span style="color:var(--cref-dis-fg);font-size:0.625rem;font-weight:700;font-family:Fredoka;line-height:0">×</span></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Active</span><span class="cref-tok-stack">88x</span><span class="cref-tok-hex" data-cref="radio-on"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Inactive</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-hex" data-cref="radio-off"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Disabled</span><span class="cref-tok-stack">80×8% OL</span><span class="cref-tok-hex" data-cref="dis-ol"></span></div></div><div class="cref-label">Radio</div></div>`,
      `</div></div>`,
