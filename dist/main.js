...
function renderComponentReference(pmd, hue) {
  ...
  if (!container.dataset.ready) {
    container.innerHTML = [
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);padding:0.5rem"><div class="cref-notif" style="background:var(--cref-notif-bg);border:2px solid var(--cref-alert-border);border-radius:var(--r);padding:0.5rem 0.75rem"><div style="font-weight:600;font-size:var(--fs);color:var(--cref-alert-fg);margin-bottom:0.125rem">Priority Title</div><div style="font-size:0.625rem;color:var(--cref-notif-bd);line-height:1.25">Body text · 80x 500 <span style="color:var(--cref-sl-track)">· meta 80×48%</span></div><div style="display:flex;gap:0.25rem;margin-top:0.375rem"><div class="cref-btn" style="background:var(--cref-alert-fg);color:var(--cref-panel);font-size:0.625rem;padding:0.25rem 0.5rem;border-radius:var(--r);font-weight:500">Action</div><div class="cref-btn" style="background:var(--cref-cta-bg);color:var(--cref-alert-fg);font-size:0.625rem;padding:0.25rem 0.5rem;border-radius:var(--r);font-weight:500">Copy</div></div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Surface</span><span class="cref-tok-stack">8x</span><span class="cref-tok-var">--base01</span><span class="cref-tok-hex" data-cref="notif-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Border</span><span class="cref-tok-stack">88×12</span><span class="cref-tok-hex" data-cref="alert-border"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Title</span><span class="cref-tok-stack">88×12 · 600</span><span class="cref-tok-hex" data-cref="alert-fg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Body</span><span class="cref-tok-stack">80x · 500</span><span class="cref-tok-hex" data-cref="notif-bd"></span></div></div><div class="cref-label">Priority</div></div>`,
