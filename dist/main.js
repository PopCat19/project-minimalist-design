...
function renderComponentReference(pmd, hue) {
  ...
  if (!container.dataset.ready) {
    container.innerHTML = [
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.5rem;display:flex"><div class="cref-radio" style="border-color:var(--cref-radio-on)"></div><div class="cref-radio" style="border-color:var(--cref-radio-off)"></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Active</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="radio-on"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Inactive</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="radio-off"></span></div></div><div class="cref-label">Radio</div></div>`,
      `</div></div>`,
