...
function renderComponentReference(pmd, hue) {
  ...
  if (!container.dataset.ready) {
    container.innerHTML = [
      ...
      `</div></div>`,
      `<div class="cref-group"><h3 class="cref-group-title">Tabs</h3><div class="cref-grid"><div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel)"><div class="cref-tab"><div class="cref-tab-sel" style="background:var(--cref-tab-sel-bg);color:var(--cref-tab-sel-fg);border-radius:var(--r) 8px 8px var(--r);padding:0.25rem 0.625rem;font-size:var(--fs);font-weight:600">Selected</div><div class="cref-tab-unsel" style="background:var(--cref-tab-unsel-bg);color:var(--cref-tab-unsel-fg);border-radius:8px var(--r) var(--r) 8px;padding:0.25rem 0.625rem;font-size:var(--fs);font-weight:500">Unselected</div></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Fill</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="tab-sel-bg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Text on</span><span class="cref-tok-stack">4x</span><span class="cref-tok-var">--base01</span><span class="cref-tok-hex" data-cref="tab-sel-fg"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Muted</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="tab-unsel-fg"></span></div></div><div class="cref-label">Selected · Unselected</div></div></div></div>`,
      ...
      `<div class="cref-card"><div class="cref-preview" style="background:var(--cref-panel);gap:0.5rem;display:flex"><div class="cref-radio" style="border:2px solid var(--cref-radio-on)"></div><div class="cref-radio" style="border:2px solid var(--cref-radio-off)"></div></div><div class="cref-tokens"><div class="cref-tok-row"><span class="cref-tok-prop">Active</span><span class="cref-tok-stack">88x</span><span class="cref-tok-var">--base06</span><span class="cref-tok-hex" data-cref="radio-on"></span></div><div class="cref-tok-row"><span class="cref-tok-prop">Inactive</span><span class="cref-tok-stack">80×48%</span><span class="cref-tok-var">--base03</span><span class="cref-tok-hex" data-cref="radio-off"></span></div></div><div class="cref-label">Radio</div></div>`,
      `</div></div>`,
